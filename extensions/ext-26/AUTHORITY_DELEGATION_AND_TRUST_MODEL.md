# EXT-26 — Authority, Delegation & Trust Model
...
EXT-26 must never originate, infer, or expand authority.

## Authority Source Doctrine

All authority exercised by EXT-26 originates from:
...
EXT-26 trust boundaries are defined by:
