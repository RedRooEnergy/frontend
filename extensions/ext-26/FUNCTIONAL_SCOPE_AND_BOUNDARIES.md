# EXT-26 — Functional Scope & Capability Boundaries
...
This document defines the exact functional scope EXT-26 is permitted to
operate within and explicitly constrains what EXT-26 is not allowed to do.

EXT-26 capabilities must remain narrow, explicit, and non-authoritative.

## Functional Scope

EXT-26 is permitted to perform ONLY the following classes of functions:
...
EXT-26 functionality must not expand through:
...
EXT-26 STEP 02 COMPLETE

Next step will be:
EXT-26 STEP 03 — Authority Separation & Decision Boundaries
