# EXT-23 — Authority Separation & Decision Boundaries
...
information handling, and authoritative decision-making for EXT-23.

EXT-23 must never become a decision authority.

## Authority Model

EXT-23 operates strictly as:
- A coordinator
- An information surface
- A workflow assistant

EXT-23 is NOT an authority.
...
EXT-23 may observe and record decisions but must not influence outcomes.
...
EXT-23 may accept inputs ONLY as:
...
**EXT-23 STEP 03 COMPLETE**

Next step will be:  
**EXT-23 STEP 04 — Data Ownership & Evidence Boundaries**
