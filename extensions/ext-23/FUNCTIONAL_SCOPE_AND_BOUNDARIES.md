# EXT-23 — Functional Scope & Capability Boundaries
...
This document defines the exact functional scope EXT-23 is permitted to
operate within and explicitly constrains what EXT-23 is not allowed to do.

EXT-23 capabilities must remain narrow, explicit, and non-authoritative.

## Functional Scope

EXT-23 is permitted to perform ONLY the following classes of functions:
...
EXT-23 functionality must not expand through:
...
**EXT-23 STEP 02 COMPLETE**

Next step will be:  
**EXT-23 STEP 03 — Authority Separation & Decision Boundaries**
