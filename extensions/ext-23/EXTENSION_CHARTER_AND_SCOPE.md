# EXT-23 — Extension Charter & Scope Definition
...
This document establishes EXT-23 as a governed, optional extension
operating alongside the Immutable Core.

EXT-23 provides additional, non-core capability without modifying,
...
EXT-23 is NOT part of the Immutable Core.

## Scope Definition

EXT-23 scope is limited to:
...
EXT-23 MUST NOT assume Core authority.
...
EXT-23 may coordinate, record, or surface information.
...
**EXT-23 STEP 01 COMPLETE**

Next step will be:  
**EXT-23 STEP 02 — Functional Scope & Capability Boundaries**
