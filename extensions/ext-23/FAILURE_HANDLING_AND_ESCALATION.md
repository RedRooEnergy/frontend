# EXT-23 — Failure Handling & Escalation Doctrine
...
This document defines how EXT-23 must behave under failure conditions,
ambiguity, or degraded operation.

EXT-23 must fail closed, escalate correctly, and never compromise Core
stability or authority.

## Failure Classification

Failures within EXT-23 are classified as:
...
EXT-23 may escalate failures ONLY by:
...
- EXT-23 MUST deny the action
- EXT-23 MUST emit an audit event
- EXT-23 MUST surface the ambiguity

Default deny applies.

## Degraded Operation

If EXT-23 enters degraded state:
...
**EXT-23 STEP 05 COMPLETE**

Next step will be:  
**EXT-23 STEP 06 — Core Integration Boundaries**
