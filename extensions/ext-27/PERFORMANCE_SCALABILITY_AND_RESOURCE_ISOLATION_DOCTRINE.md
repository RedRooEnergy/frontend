# EXT-27 — Performance, Scalability & Resource Isolation Doctrine
...
EXT-27 must not degrade Core platform performance.
...
EXT-27 does not define performance targets.
...
- EXT-27 MUST deny new actions when limits are reached
- EXT-27 MUST NOT queue excess work
- EXT-27 MUST NOT degrade Core responsiveness
