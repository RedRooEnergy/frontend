# EXT-24 — Extension Charter & Scope Definition
...
This document establishes EXT-24 as a governed, optional extension
operating alongside the Immutable Core.

EXT-24 provides additional, non-core capability without modifying,
...
EXT-24 is NOT part of the Immutable Core.

## Scope Definition

EXT-24 scope is limited to:
...
EXT-24 MUST NOT assume Core authority.
...
EXT-24 may coordinate, record, or surface information.
...
**EXT-24 STEP 01 COMPLETE**

Next step will be:  
**EXT-24 STEP 02 — Functional Scope & Capability Boundaries**
