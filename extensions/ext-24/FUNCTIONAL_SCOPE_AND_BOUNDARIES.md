# EXT-24 — Functional Scope & Capability Boundaries
...
This document defines the exact functional scope EXT-24 is permitted to
operate within and explicitly constrains what EXT-24 is not allowed to do.

EXT-24 capabilities must remain narrow, explicit, and non-authoritative.

## Functional Scope

EXT-24 is permitted to perform ONLY the following classes of functions:
...
EXT-24 functionality must not expand through:
...
**EXT-24 STEP 02 COMPLETE**

Next step will be:  
**EXT-24 STEP 03 — Authority Separation & Decision Boundaries**
