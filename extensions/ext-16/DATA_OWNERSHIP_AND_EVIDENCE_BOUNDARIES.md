# EXT-16 — Data Ownership & Evidence Boundaries
...
and data-boundary rules governing EXT-16.

EXT-16 must not become a system of record for authoritative data.
...
EXT-16 may access data only when:
