# EXT-16 — Security Threat Boundaries & Containment
...
rules governing EXT-16.

EXT-16 must not introduce escalation paths, authority leakage, or
attack surfaces affecting Core or other extensions.

## Threat Model Positioning

EXT-16 is classified as:
- Non-authoritative
- Medium visibility
- Scoped-access
- Fully isolatable

A compromise of EXT-16 MUST NOT result in Core compromise.

## Boundary Enforcement

EXT-16 MUST operate strictly within:
...
- EXT-16 must be disableable immediately
...
On security-relevant failure:
- EXT-16 halts execution
...
Any suspected security incident involving EXT-16:
- Triggers Core incident response
- Is auditable
- Cannot be suppressed or self-dismissed

EXT-16 cannot classify incidents independently.
