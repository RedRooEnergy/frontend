# EXT-16 — Auth Boundaries & Scope Enforcement
...
boundaries governing all access to EXT-16 functionality.

EXT-16 enforces access strictly through Core identity and scope controls.
