# EXT-18 — Authority Separation & Decision Boundaries
...
information handling, and authoritative decision-making for EXT-18.

EXT-18 must never become a decision authority.

## Authority Model

EXT-18 operates strictly as:
- A coordinator
- An information surface
- A workflow assistant

EXT-18 is NOT an authority.
...
EXT-18 may observe and record decisions but must not influence outcomes.
...
EXT-18 may accept inputs ONLY as:
...
- EXT-18 MUST deny the action
- EXT-18 MUST emit an audit event
