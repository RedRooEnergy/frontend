# EXT-17 — Failure Handling & Escalation Doctrine
...
This document defines how EXT-17 must behave under failure conditions,
ambiguity, or degraded operation.

EXT-17 must fail closed, escalate correctly, and never compromise Core
stability or authority.

## Failure Classification

Failures within EXT-17 are classified as:
...
EXT-17 may escalate failures ONLY by:
...
- EXT-17 MUST surface the ambiguity

Default deny applies.

## Degraded Operation

If EXT-17 enters degraded state:
