# EXT-22 — Failure Handling & Escalation Doctrine
...
This document defines how EXT-22 must behave under failure conditions,
ambiguity, or degraded operation.

EXT-22 must fail closed, escalate correctly, and never compromise Core
stability or authority.

## Failure Classification

Failures within EXT-22 are classified as:
...
EXT-22 may escalate failures ONLY by:
...
- EXT-22 MUST surface the ambiguity

Default deny applies.

## Degraded Operation

If EXT-22 enters degraded state:
...
**EXT-22 STEP 05 COMPLETE**

Next step will be:  
**EXT-22 STEP 06 — Core Integration Boundaries**
