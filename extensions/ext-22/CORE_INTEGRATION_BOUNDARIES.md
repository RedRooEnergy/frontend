# EXT-22 — Core Integration Boundaries
...
This document defines the mandatory boundaries governing how EXT-22
may integrate with, observe, and interact with the Immutable Core.

EXT-22 must integrate without modifying, bypassing, or weakening
Core controls.
...
Core must remain fully functional if EXT-22 is disabled or removed.

## Approved Interaction Modes

EXT-22 may interact with Core ONLY via:
...
All Core data accessed by EXT-22 must be:
...
- EXT-22 must halt the affected action
...
**EXT-22 STEP 06 COMPLETE**

Next step will be:  
**EXT-22 STEP 07 — Auth Boundaries & Scope Enforcement**
