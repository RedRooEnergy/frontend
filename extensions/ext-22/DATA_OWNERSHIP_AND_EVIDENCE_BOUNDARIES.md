# EXT-22 — Data Ownership & Evidence Boundaries
...
and data-boundary rules governing EXT-22.

EXT-22 must not become a system of record for authoritative data.
...
EXT-22 may access data only when:
...
EXT-22 STEP 04 COMPLETE

Next step will be:  
EXT-22 STEP 05 — Failure Handling & Escalation Doctrine
