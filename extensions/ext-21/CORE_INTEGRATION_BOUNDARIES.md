# EXT-21 — Core Integration Boundaries
...
This document defines the mandatory boundaries governing how EXT-21
may integrate with, observe, and interact with the Immutable Core.

EXT-21 must integrate without modifying, bypassing, or weakening
Core controls.
...
Core must remain fully functional if EXT-21 is disabled or removed.

## Approved Interaction Modes

EXT-21 may interact with Core ONLY via:
...
All Core data accessed by EXT-21 must be:
...
- EXT-21 must halt the affected action
...
EXT-21 STEP 06 COMPLETE

Next step will be:  
EXT-21 STEP 07 — Auth Boundaries & Scope Enforcement
