# EXT-21 — Authority Separation & Decision Boundaries
...
information handling, and authoritative decision-making for EXT-21.

EXT-21 must never become a decision authority.

## Authority Model

EXT-21 operates strictly as:
- A coordinator
- An information surface
- A workflow assistant

EXT-21 is NOT an authority.
...
EXT-21 may observe and record decisions but must not influence outcomes.
...
EXT-21 may accept inputs ONLY as:
...
EXT-21 STEP 03 COMPLETE

Next step will be:  
EXT-21 STEP 04 — Data Ownership & Evidence Boundaries
