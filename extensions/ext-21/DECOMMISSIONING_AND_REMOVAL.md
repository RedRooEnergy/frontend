# EXT-21 — Decommissioning & Safe Removal
...
disabling, decommissioning, or permanently removing EXT-21.

EXT-21 must be removable at any time without disrupting Core
...
No Core capability may rely on EXT-21 availability.
...
EXT-21 must not own authoritative data.
...
EXT-21 STEP 12 COMPLETE

Next step will be:  
EXT-21 FINAL — Extension Certification & Closure
