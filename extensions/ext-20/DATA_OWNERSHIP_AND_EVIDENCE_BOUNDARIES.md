# EXT-20 — Data Ownership & Evidence Boundaries
...
and data-boundary rules governing EXT-20.

EXT-20 must not become a system of record for authoritative data.
...
EXT-20 may access data only when:
...
- EXT-20 MUST deny action
- EXT-20 MUST emit an audit event
