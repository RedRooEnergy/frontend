# EXT-28 — Scope Isolation & Extension Containment Doctrine
...
EXT-28 must remain strictly self-contained.

## Scope Definition

EXT-28 scope is limited to:
...
On failure:
- Effects are contained within EXT-28
