# EXT-28 — Extension Lifecycle, Enablement & Decommissioning Doctrine
...
decommissioning requirements governing EXT-28.

EXT-28 must never be implicitly enabled or silently retired.

## Lifecycle States

EXT-28 operates only within the following states:
...
EXT-28 may be enabled ONLY when:
...
EXT-28 may be decommissioned ONLY when:
