# EXT-28 — Authority, Delegation & Trust Model
...
EXT-28 must never originate, infer, or expand authority.

## Authority Source Doctrine

All authority exercised by EXT-28 originates from:
...
EXT-28 is not an authority source.

## Delegation Constraints

EXT-28 may act ONLY when:
...
EXT-28 trust boundaries are defined by:
...
EXT-28 STEP 03 COMPLETE

Next step will be:
EXT-28 STEP 04 — Data Ownership & Evidence Boundaries
