# EXT-25 — Functional Scope & Capability Boundaries
...
This document defines the exact functional scope EXT-25 is permitted to
operate within and explicitly constrains what EXT-25 is not allowed to do.

EXT-25 capabilities must remain narrow, explicit, and non-authoritative.

## Functional Scope

EXT-25 is permitted to perform ONLY the following classes of functions:
...
EXT-25 functionality must not expand through:
...
EXT-25 STEP 02 COMPLETE

Next step will be:
EXT-25 STEP 03 — Authority Separation & Decision Boundaries
