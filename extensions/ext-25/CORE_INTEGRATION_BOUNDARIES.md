# EXT-25 — Core Integration Boundaries
...
This document defines the mandatory boundaries governing how EXT-25
may integrate with, observe, and interact with the Immutable Core.

EXT-25 must integrate without modifying, bypassing, or weakening
Core controls.
...
Core must remain fully functional if EXT-25 is disabled or removed.

## Approved Interaction Modes

EXT-25 may interact with Core ONLY via:
...
All Core data accessed by EXT-25 must be:
...
- EXT-25 must halt the affected action
...
**EXT-25 STEP 06 COMPLETE**

Next step will be:  
**EXT-25 STEP 07 — Auth Boundaries & Scope Enforcement**
